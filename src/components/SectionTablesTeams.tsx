...
const SectionTablesTeams = () => {
  return (
    <div>
        {/* font-extrabold */}
        <h1 className="mb-4 text-3xl  text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-first from-firstDanger">Logo</span></h1>
